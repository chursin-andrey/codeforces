...
rem set VS_HOME=C:\Program Files\Microsoft Visual Studio 9.0
set VC_HOME=%VS_HOME%\VC
set MSDK_HOME=C:\Program Files (x86)\Microsoft SDKs\Windows\v7.0A
rem set MSDK_HOME=C:\Program Files\Microsoft SDKs\Windows\v6.0A
...
cl /Fo.\solution.obj /c /F268435456 /O2 /EHsc /I"%VC_HOME%\include" /FI"%~dp0\checker_patch\solution_include.h" .\solution.cpp
cl /Fo.\checker.obj /c /F268435456 /O2 /EHsc /I"%VC_HOME%\include" /I"%MSDK_HOME%\include" /I"%~dp0\testlib" /FI"%~dp0\checker_patch\checker_include.h" "%~dp0\testlib\checkers\%CHECKER%.cpp"
echo. & echo.
...
link /out:.\checker.exe /libpath:"%MSDK_HOME%\lib" /libpath:"%VC_HOME%\lib" .\solution.obj .\checker.obj
echo. & echo.


del .\solution.obj .\checker.obj >nul 2>nul
